...
if __name__=="__main__":
    ...
    bar_width = 0.5
    plt.bar(x-bar_width/2, y_c, width=bar_width, label='T-ary Complete Information Model')
    plt.bar(x+bar_width/2, y_ic, width=bar_width, label='T-ary Incomplete Information Model', color='r')
